...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.pid'
        db.add_column(u'chronograph_job', 'pid',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Job.host'
        db.add_column(u'chronograph_job', 'host',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Job.pid'
        db.delete_column(u'chronograph_job', 'pid')

        # Deleting field 'Job.host'
        db.delete_column(u'chronograph_job', 'host')
    ...
    models = {
        ...
        u'chronograph.job': {
            ...
            'host': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'chronograph.log': {
            ...
            'hostname': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
