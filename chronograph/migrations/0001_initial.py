    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('command', models.CharField(help_text='A shell command.', max_length=255, verbose_name='shell command', blank=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('next_run', models.DateTimeField(help_text="If you don't set this it will be determined automatically", null=True, blank=True)),
